...
// NewHTTPClient creates a new grandturk kafeido API documentations HTTP client.
func NewHTTPClient(formats strfmt.Registry) *GrandturkKafeidoAPIDocumentations {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new grandturk kafeido API documentations HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *GrandturkKafeidoAPIDocumentations {
...
// New creates a new grandturk kafeido API documentations client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *GrandturkKafeidoAPIDocumentations {
	// ensure nullable parameters have default
	if formats == nil {
