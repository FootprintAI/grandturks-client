...
func NewDeleteCommand(logger log.Logger, ioStreams genericclioptions.IOStreams, newCmdFuncs ...NewCommandFunc) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "delete",
	...
	cmd.AddCommand(NewDeleteProjectCommand(logger, ioStreams))
