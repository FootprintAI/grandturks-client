...
func (p *pkgLoggerAdaptor) Debug(fmtStr string, values ...interface{}) {
	p.k8sLogger.V(1).Infof(fmtStr, values...)
}

func (p *pkgLoggerAdaptor) Info(fmtStr string, values ...interface{}) {
	p.k8sLogger.V(0).Infof(fmtStr, values...)
}
...
func (p *pkgLoggerAdaptor) Debugx(_ context.Context, fmtStr string, values ...interface{}) {
	p.k8sLogger.V(1).Infof(fmtStr, values...)
}
